...
(function ($) {
	...
	$('body').append(" \
		<div class='light-switcher'> \
			<img class='light-img' src='/assets/img/light-style.png' title='Switch to light style'> \
			<img class='dark-img' src='/assets/img/dark-style.png' title='Switch to dark style'> \
		</div>"
	);
